...
\midrule
Taxa de detecção de eventos verdadeiros     & ${\sim}99\%$                      & Limitada em baixas energias  \\
Pixels enviados ao iDBSCAN (por imagem)     & ${\sim}450$                       & ${\sim}50{.}000$             \\
Clusters falsos por evento (mediana)        & ${\sim}3$--$4$                    & ${\sim}30$                   \\
Integral de cluster ($S_c$, 0,25--1~keV)   & Próxima ao \textit{ground truth}  & Alta imprecisão              \\
